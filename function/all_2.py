...
def delete_data(file_path):
    ...
    # ยืนยันการลบข้อมูล
    confirmation = colored_input(f"คุณต้องการลบข้อมูลของลำดับ {delete_index} หรือไม่? (y/n): ").lower()
    if confirmation == 'y':
        # ลบข้อมูล
...
def search_data(file_path):
    ...
    # รับคำค้นหาจากผู้ใช้
    search_term = colored_input("กรุณากรอกคำที่ต้องการค้นหา (สามารถค้นหาจาก ลำดับ, รายการ, S/N, อาการ หรือ ขนาดจอ): ").strip()
